...
- 创建聚合工程 com.guli.mall.mall-parent 并统一设置依赖，Spring Boot 版本根据后续的 Spring Cloud Alibaba 中建议的设置
- 创建各个业务微服务：
    - mall-coupon：优惠券微服务
    - mall-member：用户微服务
    - mall-product：商品微服务
...
- 下载 renren-fast，重命名为 mall-admin，引入到 mall-parent，并作为其伪 module 存在，其 parent 仍然是自身的 spring boot，因此要添加 `<relativePath/>`
